...
<div class="wrapper">
 ...
 <div class="content-wrapper">
        ...
        <a href="create_rental.php?id=<?php echo $agar["id"]; ?>" class="btn btn-success"><span> إضافة مستأجر</span></a>
        </p>    
      ...
      <td><?php echo $row["id"];?></td>				
        ...
        <td>
        <a href="http://localhost/houses/uploads/" class="fa fa-tag " >  العقد </a></td>
        ...
        <td>
            ...
            <a href="maintenance_flag.php?id=<?php echo $row["id"]; ?>" class="btn btn-success"><span>صيانة</span></a>
