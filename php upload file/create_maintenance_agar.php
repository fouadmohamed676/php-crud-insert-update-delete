...
$agar = mysqli_query($conn,"SELECT * FROM maintace WHERE id='" . $_GET['id'] . "'");
$row = mysqli_fetch_array($agar);
$result = mysqli_query($conn,"SELECT * FROM aqar WHERE id='" . $_GET['id'] . "'");
$aq = mysqli_fetch_array($result);
 ...
 <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <div class="box-body">
                <form action="add_agar_maintenance.php" method="post" enctype="multipart/form-data">
                    <!-- <form action="add_rental.php" method="post"> -->
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" required name="date_m" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label></label> 	
                                    <input type="hidden" required name="rental" value="<?php echo $_GET['id'] ; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
