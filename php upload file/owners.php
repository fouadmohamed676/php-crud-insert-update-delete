...
<div class="wrapper">
 ...
 <div class="content-wrapper">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                     ...
                     <div class="row">
                            ...
                            <!-- <div class="col-md-4">
                                <a href="add_owner.php"class="btn btn-primary"><i class="fa fa-plus"></i>اضافه بيانات الملاك</a>
                            </div> -->
	  ...
	  <tr>
		...
		<td>
        <a href="agar_owner.php?id=<?php echo $row["id"]; ?>" class="btn btn-success">إدارة</a>
        <a href="update_owner.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary">تعديل</a>
        
		<a href="delete_owner_n.php?id=<?php echo $row["id"];
