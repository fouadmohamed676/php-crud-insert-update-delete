...
<div class="wrapper">
 ...
 <div class="content-wrapper">
        <section class="content-header">
            <strong>عرض عقارات المالك</strong>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <a href="create_agar.php?id=<?php echo $row["id"]; ?>" class="btn btn-success">إضافة</a></td>
...
$result = mysqli_query($conn,"SELECT * FROM aqar WHERE id='" . $_GET['id'] . "'");
	  ...
	  <tr>	 	 	 	 	
        ...
        <td><a href="update_agar.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary">تعديل</a>
		<a href="agar.php?id=<?php echo $row["id"]; $sql = "DELETE FROM agar WHERE id='" . $_GET["id"] . "'"; 
