...
$result = mysqli_query($conn,"SELECT * FROM aqar WHERE owner_id='" . $_GET['id'] . "'");
 ...
 <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <a href="create_agar.php?id=<?php echo $row["id"]; ?>" class="btn btn-success"><span> إضافة عقار</span></a>
	  ...
	  <tr>	 	 	 	 	
        ...
        <td>
        <a href="http://localhost/houses/uploads/" class="fa fa-tag">المستند</a></td>
       
        <td>
        <a href="maintenance_agar.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary">الصيانة</a>
        <a href="rental_id.php?id=<?php echo $row["id"]; ?>" class="btn btn-success"><span>المستأجرين</span></a>

        <a href="update_agar.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary">تعديل</a>
		<a href="delete_agar_owner.php?id=<?php echo $row["id"]; $sql = "DELETE FROM aqar WHERE id='" . $_GET["id"] . "'"; 
