...
if(count($_POST)>0) {		
mysqli_query($conn,"UPDATE maintenance_flag set id='" . $_POST['id'] . "', cost='" . $_POST['cost'] . "', type='" . $_POST['type'] .  "' ,rental_id='" . $_POST['rental_id'] .  "' ,date_m='" . $_POST['date_m'] . "' WHERE id='" . $_POST['id'] . "'");
// header("Location: maintenance_flag.php?id=$_POST[id]");
$message = "تم التعديل ";
}
$result = mysqli_query($conn,"SELECT * FROM maintenance_flag WHERE id='" . $_GET['id'] . "'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input required type="number" name="rental_id" class="txtField" value="<?php echo $row['rental_id']; ?>">
                                </div>
                            </div>
