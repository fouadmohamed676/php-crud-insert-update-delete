...
$agar = mysqli_query($conn,"SELECT * FROM maintenance_flag WHERE id='" . $_GET['id'] . "'");
 ...
 <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <div class="box-body">
                <form action="add_maintenance.php" method="post" enctype="multipart/form-data">
                    <!-- <form action="add_rental.php" method="post"> -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label></label>
                                    <input type="hidden" required name="rental_id" value="<?php echo $_GET['id'] ; ?>" class="form-control">
                                </div>
                            </div>
                        </div>
