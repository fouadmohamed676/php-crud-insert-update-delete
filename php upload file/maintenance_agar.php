...
$result = mysqli_query($conn,"SELECT * FROM maintace WHERE rental='" . $_GET['id'] . "'");
$resu = mysqli_query($conn,"SELECT * FROM aqar WHERE id='" . $_GET['id'] . "'");
...
<div class="wrapper">
 ...
 <div class="content-wrapper">
        ...
        <a href="create_maintenance_agar.php?id=<?php echo $maint["id"]; ?>" class="btn btn-success"><span> إضافة صيانة</span></a>
        </p>    
      ...
      <td><?php echo $i; ?></td>				
        ...
        <td>
        <a href="update_maintenance_agar.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary">تعديل</a>
	
        <a href="delete_owner.php?id=<?php echo $row["id"]; 
