...
$result = mysqli_query($conn,"SELECT * FROM maintenance_flag WHERE rental_id='" . $_GET['id'] . "'");
$resu = mysqli_query($conn,"SELECT * FROM maintenance_flag WHERE id='" . $_GET['id'] . "'");
$row = mysqli_fetch_array($result);
$maint = mysqli_fetch_array($resu);
...
<div class="wrapper">
 ...
 <div class="content-wrapper">
        ...
        <a href="create_maintenance.php?id=<?php echo $maint["id"]; ?>" class="btn btn-success"><span> إضافة صيانة</span></a>
        </p>    
      ...
      <td><?php echo $i; ?></td>				
       ...
       <a href="update_mantanance_flag.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary">تعديل</a>
	
    <a href="delete_m_f.php?id=<?php echo $row["id"]; 
