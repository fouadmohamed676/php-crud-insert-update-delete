...
$result = mysqli_query($conn,"SELECT * FROM maintace WHERE id='" . $_GET['id'] . "'");
$row= mysqli_fetch_array($result);

	
	

    mysqli_query($conn,"UPDATE maintace set id='" . $_POST['id'] . "', cost='" . $_POST['cost'] . "', bill='" . $_POST['bill'] . "', type='" . $_POST['type'] .  "' ,rental='" . $_POST['rental'] .  "' ,date_m='" . $_POST['date_m'] . "' WHERE id='" . $_POST['id'] . "'");
    // header("Location: maintenance_agar.php?id=$_GET[id]");
    $message = "تم التعديل ";
                    ...
                    <?php if(isset($message)) { echo $message; } ?>
                        ...
                        <div class="row">				 	
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="date_m" class="txtField" value="<?php echo $row['date_m']; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <!-- <input required type="text" name="type" class="txtField" value=""> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input required type="text" name="bill" class="txtField" value="<?php echo $row['bill']; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input required type="number" name="rental" class="txtField" value="<?php echo $row['rental']; ?>">
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    <label> التكلفه</label>
                                    <br>
                                    <input required type="number" name="cost" class="txtField" value="<?php echo $row['cost']; ?>">
                                </div>
                            </div>
